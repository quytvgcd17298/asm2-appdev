namespace GES_APP.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
        ...
        {
            DropForeignKey("dbo.TeachingTopics", "TrainerId", "dbo.AspNetUsers");
            DropForeignKey("dbo.TeachingTopics", "TopicId", "dbo.Topics");
            DropForeignKey("dbo.Students", "ApplicationUser_Id", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserRoles", "RoleId", "dbo.AspNetRoles");
            DropForeignKey("dbo.Lecturers", "TopicId", "dbo.Topics");
            ...
            DropIndex("dbo.TeachingTopics", new[] { "TopicId" });
            DropIndex("dbo.TeachingTopics", new[] { "TrainerId" });
            DropIndex("dbo.Students", new[] { "ApplicationUser_Id" });
            DropIndex("dbo.AspNetRoles", "RoleNameIndex");
            DropIndex("dbo.Lecturers", new[] { "TopicId" });
